...
(33) The first row which contains the sum of all crops in NRW (we just want the single districts) was dropped
...
(37-40) the names of the rows in l are reduced from the data name to only the yearnumber and are reffered to as year
