...
#crop categories
Getreide = 'Getreide+' + 'Getreide-' +  'Brotgetreidearten' + 'Wintergetreide' + 'Futtergetreide' +  'Sommergetreide' + 'Titricale'
Weizen = Winterweizen, Sommerweizen, Rauhfutter Getreideganz, Hartweizen, Weizen
...
Gras = Wiesen, Weiden, Feldgras

# TODO reduce crop to categories
fin2 = fin %>%
  group_by(gen, year, rs, shape_area) %>%
  summarise()
...
#TODO summe der Messwerte pro Site pro PSM-Typ


#TODO Karte der Pestizide mit intensiver LW-Fläche vergleichen

#TODO Visualisierung

#TODO Intersection + Visualisierung
